...
public class HttpPostMultiClient extends cn.finder.httpcommons.HttpPostClient {
	...
	public HttpPostMultiClient(String url,String appKey, String appSecret) {
		super(url);
		this.appKey = appKey;
	...
	public HttpPostMultiClient(String serverUrl, String format,String appKey, String appSecret)
   {
		super(serverUrl,format);
		this.appKey = appKey;
	   	this.appSecret=appSecret;
   }
   public HttpPostMultiClient(String serverUrl, String format,boolean disableParser,String appKey, String appSecret)
   {
   ...
   public  <T extends ApiResponse>  T doExecute(BaseRequest<T> request, String session, Date timestamp)
   {
       ...
       try
       {
           ...
           {//  二进制(文件、图片)请求
               ...
               retStr = this.webUtils.doPostMultiPlatform(this.url, parameters, fileParams);
