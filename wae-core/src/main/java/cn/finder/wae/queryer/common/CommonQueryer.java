 ...
 *
 */
public class CommonQueryer extends  BaseCommonDBQueryer{

	
	private final static Logger logger = Logger.getLogger(CommonQueryer.class);
	...
	public TableQueryResult queryTableQueryResult(long showTableConfigId,
	   ...
	   final  List<String> filedNames=new ArrayList<String>();
	    ...
	    sql_cnt_sb.append("select ").append(" count(1) cnt ").append(" from ").append(showTableConfig.getShowTableName()).append(" alias ").append("  ").append(" where 1=1 ");
	    //oracle
	...
	public void setJDBCDataSource(DataSource dataSource) {
		...
		logger.debug(" === ds:"+basicDataSource.getUrl());
	}
